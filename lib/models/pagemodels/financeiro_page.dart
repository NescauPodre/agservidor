...
import 'package:agservidor/models/button_models/formulariosmodels.dart';

import 'package:agservidor/models/pagemodels/pageviewnavigation.dart';
import 'package:agservidor/services/pdfmat_generator.dart';
            ...
            child: Container(
              ...
              child: InkWell(
                  onTap: () {
                    showModalBottomSheet(
                        isScrollControlled: true,
                        backgroundColor: Color(0xff264D74),
                        context: context,
                        builder: ((context) => PDFView()));
                  },
                  child: const Center(
