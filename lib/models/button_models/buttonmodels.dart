import 'package:agservidor/models/pagemodels/financeiro_page.dart';
import 'package:agservidor/models/pagemodels/pageviewnavigation.dart';
...
class menubutton extends StatelessWidget {
  menubutton(
      {required this.iconM, required this.textM, required this.onpressedM});
  IconData iconM;
  String textM;
  final onpressedM;
...
class MyDropDownMenubelow extends StatefulWidget {
  const MyDropDownMenubelow({super.key});

  @override
  State<MyDropDownMenubelow> createState() => _MyDropDownMenubelowState();
}

class _MyDropDownMenubelowState extends State<MyDropDownMenubelow> {
  @override
  Widget build(BuildContext context) {
    return Container(
      child: Column(),
