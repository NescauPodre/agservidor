...
import 'package:agservidor/boasVindas_page.dart';
import 'package:agservidor/models//button_models/buttonmodels.dart';
import 'package:agservidor/content_login/login_page.dart';
import 'package:agservidor/models/pagemodels/ajuda_page.dart';
                      ...
                      children: [
                        Padding(
                          padding: EdgeInsets.fromLTRB(_size.width * 0.06,
                              _size.height * 0.07, 0, _size.height * 0.15),
                          child: Image.asset(
                            'assets/logo.png',
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: CustomPaint(
                        size: Size(double.infinity, _size.height * 0.15),
                        painter: mamasmamas(),
                      ),
                    ),
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Padding(
                              padding: EdgeInsets.only(
                                  left: _size.width * 0.20), //botão ajuda
                              child: helpbutto()),
                        ],
                      ),
                    ),
